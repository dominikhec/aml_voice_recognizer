...
if __name__ == "__main__":
    ...
    # Poniżej znajduje się fragment kodu odpowiedzialny za augmentację nagrań JARVIS_dataset_training 
        ...
        raw_training_dataset = google_dataset_training + urban_sounds_dataset_training + esc50_dataset_training + JARVIS_dataset_training + cisza_training + pokoj_training + czytanie_training
        raw_validation_dataset = google_dataset_validation + urban_sounds_dataset_validation + esc50_dataset_validation + JARVIS_dataset_validation + cisza_validation + pokoj_validation + czytanie_validation
